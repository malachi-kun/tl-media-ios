...
class VoiceArticleCell:UICollectionViewCell {
    ...
    private func setupView(){
        ...
        titleLabel.anchor(top: nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 20, paddingLeft: 10, paddingBottom: -20, paddingRight: 100, width: 0, height: 0)
